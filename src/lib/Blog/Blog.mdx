...
An interesting animation needs variety. Highly repetitive elements don't look or feel natural. They aren't engaging. To make something look nice you have to pay the price that comes with expressing lots of variety in configuration.

#### Issue 1 - Lots of configuration options

Even in a simple project like this one there are 63 things (at time of writing) you could configure if you wanted to. They were all linked to different aspects of the animations. That's quite a lot of config already.
...
### Making a prototype with AI is quick but comes with tradeoffs.
...
But, to communicate the ideas in it and turn it into a package that someone with no context might be able to configure and understand? That took longer. It required breaking out components and structures from the mass of ai code and simplifying a few concepts for reuse.
An AI consuming from AI world awaits us though. Human communication and clarity becomes less important as long as whatever AI generates **just works**. But for the moment, the AI human relationship is symbiotic and I think good packages still needs to communicate clearly for both parties and that just takes a bit of extra time. 
